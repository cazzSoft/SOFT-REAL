<div class="modal fade" id="formModaAcabado" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
     ...
     <form id="formAcabado" method="POST" action="{{url('admin/construccion/acabado/cubiertaventana')}}"  enctype="multipart/form-data"  class="form-horizontal form-label-left">
         {{csrf_field() }}
