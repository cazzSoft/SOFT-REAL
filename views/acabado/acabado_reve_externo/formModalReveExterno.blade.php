<div class="modal fade" id="formModaAcabado" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
     ...
     <form id="formAcabado" method="POST" action="{{url('admin/construccion/acabado/revestido/externo')}}"  enctype="multipart/form-data"  class="form-horizontal form-label-left">
         {{csrf_field() }}
        ...
        <div class="modal-body ">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="number" step="0.00001" class="form-control" stip id="indice" name="indice" value="{{ old('indice') }}" placeholder="Indice" required>
                </div>
              </div>
